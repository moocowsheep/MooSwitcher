...
enum class PixFmt : uint8_t { UYVY8_422 = 0 };  // P216 lands in v1.1
...
struct VideoFormatDesc {
    ...
    size_t frameBytes() const { return size_t(width) * height * 2; }  // UYVY
    size_t rowBytes() const { return size_t(width) * 2; }
